...
import { Menu, PanelLeftIcon, XCircle } from 'lucide-react';
  ...
  return (
    <main
      ...
      className={cn(
        ...
        'md:peer-data-[variant=inset]:m-0 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-3xl md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2',
        className
      )}
      {...props}
    />
